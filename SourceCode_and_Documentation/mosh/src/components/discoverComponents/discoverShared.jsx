...
function discoverShared() {
    ...
    return (
        <div style = {{display: "flex", flexDirection: "column"}}> 
            ...
            <Grid style = {cardStyles}>
                <MediaControlCard title = "Don't Start Now" artist = "Dua Lipa" album = "Future Nostalgia" img = "https://t2.genius.com/unsafe/220x220/https%3A%2F%2Fimages.genius.com%2Fe4c769de3006686a03da334039bd13a8.600x600x1.png"/>
            </Grid>
        </div>
    )
}
